...
namespace PlayFab
{
    ...
    public static class PlayFabClientAPI
    {
        ...
        public static bool LoginWithEmailAddress(LoginWithEmailAddressRequest loginWithEmailAddressRequest, Action<LoginResult> value, PlayFabError playFabError, object error)
        {
